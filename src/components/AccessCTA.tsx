...
export function AccessCTA({ locale }: { locale: Locale }) {
  ...
  const secureAccessLabel = locale === "zh" ? "[ 安全访问 ]" : "[ SECURE_ACCESS_PORTAL ]";
  ...
  const openDashboardLabel = locale === "zh" ? "打开安全面板" : "OPEN_SECURE_DASHBOARD";
            ...
            <div className="max-w-2xl space-y-8">
              ...
              <p className="text-[15px] leading-[1.8]" style={{ color: "var(--body)" }}>
                {locale === "en"
                  ...
                  : "通过 ROS NAT 以 HTTPS 直接访问控制面板，安全接入监控节点与遥测接口。"}
              </p>
