...
export const datacenters: Datacenter[] = [
  ...
  },
  {
    ...
    notes: {
      en: "Thailand node cluster extending Southeast Asia reach for public access, routing diversity, and future capacity growth.",
      zh: "泰国节点集群扩大东南亚覆盖，用于公网访问、路由多样性与后续容量增长。",
    },
  ...
  },
  {
    ...
    tags: [
      { en: "Edge Node", zh: "边缘节点" },
      { en: "APAC Relay", zh: "亚太中继" },
      { en: "Public Access", zh: "公网访问" },
    ],
    notes: {
      en: "Kuala Lumpur edge node providing Southeast Asia relay coverage and cross-strait connectivity.",
      zh: "吉隆坡边缘节点，提供东南亚中继覆盖与跨海峡互联。",
    },
